...
<template>
  ...
  <!-- 為什麼推薦？bottom sheet(解說 + 隱私開關) -->
  <BottomSheet :open="sheetOpen" title="為什麼推薦這個？" @close="sheetOpen = false">
    <section class="mb-5">
...
/* 「為什麼推薦？」sheet 的 overlay/轉場/容器樣式已移入 components/common/BottomSheet.vue */
</style>
